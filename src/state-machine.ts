    ...
    run: sequence<Controllers>([
        ...
        // Checkup Phase - process status effects
        {
            ...
            run: (controllers: Controllers) => {
                ...
                // Clear status conditions from creatures protected by status-prevention passives
                // (e.g. Comfey's Flower Shield removes existing conditions before damage is applied)
                for (let playerId = 0; playerId < 2; playerId++) {
