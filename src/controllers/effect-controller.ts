...
export type EffectState = {
    ...
    /**
     * Future effects waiting for a matching phase and turn.
     */
    scheduledFutureEffects: ScheduledFutureEffect[];
...
export type ScheduledFutureEffect = {
    id: string;
    sourcePlayer: number;
    effectName: string;
    effects: Effect[];
...
export class EffectController extends GlobalController<EffectState, EffectControllerDependencies> {
    ...
    public scheduleFutureEffect(
        ...
        const id = `future-effect-${this.state.nextEffectId++}`;

        this.state.scheduledFutureEffects.push({
            id,
            sourcePlayer,
            effectName,
            effects,
    ...
    public processDueFutureEffects(
        ...
        this.state.scheduledFutureEffects = this.state.scheduledFutureEffects.filter(effect => {
