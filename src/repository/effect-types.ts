 ...
 */
export type HpEffect<TContextualRefs extends string = string> = {
    type: 'hp';
    amount: EffectValue;
 ...
 */
export type StatusEffect<TContextualRefs extends string = string> = {
    type: 'status';
 ...
 */
export type EnergyAttachEffect<TContextualRefs extends string = string> = {
    type: 'energy-attach';
 ...
 */
export type EnergyDiscardEffect<TContextualRefs extends string = string> = {
    type: 'energy-discard';
    energySource: EnergyTarget<TContextualRefs>;
};
 ...
 */
export type SwitchEffect<TContextualRefs extends string = string> = {
    type: 'switch';
    target: FieldTarget<TContextualRefs>;
    switchWith: FieldTarget<TContextualRefs>;
};
 ...
 */
export type EnergyTransferEffect<TContextualRefs extends string = string> = {
    type: 'energy-transfer';
    source: EnergyTarget<TContextualRefs>;
    target: FieldTarget<TContextualRefs>;
};
 ...
 * @property {FieldTargetCriteria} target - Criteria for which creatures to protect (evaluated passively)
 * @property {Duration} duration - How long the protection persists
 * @example { type: 'damage-reduction', amount: { type: 'constant', value: 20 }, damageSource: { fieldCriteria: { attributes: { ex: true } } }, target: { player: 'self', position: 'active' }, duration: 'this-turn' }
 ...
 * @property {FieldTargetCriteria} target - Which opponent creatures receive the boosted damage (evaluated passively)
 * @property {Duration} duration - How long the boost persists
 * @example { type: 'damage-boost', amount: { type: 'constant', value: 30 }, damageSource: { fieldCriteria: { attributes: { ex: true } } }, target: { player: 'opponent', position: 'active' }, duration: 'this-turn' }
 ...
 * @property {string} type - Always 'future' to identify this effect type
 ...
 */
export type FutureEffect<TContextualRefs extends string = string> = {
    type: 'future';
    delayTurns: number;
 ...
 */
export type ImmediateEffect<TContextualRefs extends string = string> =
    | HpEffect<TContextualRefs>
    | StatusEffect<TContextualRefs>
    | DrawEffect
 ...
 */
export type ToolDiscardEffect<TContextualRefs extends string = string> = {
    type: 'tool-discard';
    target: FieldTarget<TContextualRefs>;
};
 ...
 */
export type StatusRecoveryEffect<TContextualRefs extends string = string> = {
 ...
 */
export type RemoveFieldCardEffect<TContextualRefs extends string = string> = {
 ...
 * All modifier effects use FieldTargetCriteria for passive criteria-based matching at query time.
 */
 ...
 * @example { type: 'passive', modifier: { type: 'damage-reduction', amount: { type: 'constant', value: 20 }, damageSource: { player: 'opponent' }, target: { player: 'self', position: 'active' }, duration: { type: 'while-in-play' } } }
