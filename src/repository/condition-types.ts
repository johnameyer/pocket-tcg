 ...
 * @property {string} [previousStageName] - Check if FieldCard evolves from a specific creature name
 ...
 * @example { previousStageName: 'Basic Creature' } // FieldCard evolves from Basic Creature
 */
